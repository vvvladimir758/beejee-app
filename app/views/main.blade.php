...
@section('content')
  ...
  <thead>
    <tr>
      <th scope="col"><a href="{{$sitePath}}main/{{$page}}/task_id/{{ $orderType == 'desc' ? 'asc' : 'desc'}}">#</a></th>
      <th scope="col"><a href="{{$sitePath}}main/{{$page}}/name/{{ $orderType == 'desc' ? 'asc' : 'desc'}}">Автор</a></th>
      <th scope="col"><a href="{{$sitePath}}main/{{$page}}/descripition/{{ $orderType == 'desc' ? 'asc' : 'desc'}}">Текст</a></th>
      <th scope="col"><a href="{{$sitePath}}main/{{$page}}/status/{{ $orderType == 'desc' ? 'asc' : 'desc'}}">Статус</a></th>
